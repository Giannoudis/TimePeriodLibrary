...
namespace Itenso.TimePeriodTests
{
    ...
    public sealed class CalendarDateDiffTest : TestUnitBase
    {
        ...
        {
            var date = new DateTime(2011, 4, 12);

            var calendarDateDiff = new CalendarDateDiff();
        ...
        {
            var date1 = new DateTime(2011, 4, 12);
        ...
        {
            var date1 = new DateTime(2011, 9, 11, 18, 0, 0);
            var date2 = new DateTime(2011, 9, 15, 9, 0, 0);

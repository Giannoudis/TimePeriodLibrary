...
namespace Itenso.TimePeriodTests
{
    ...
    public sealed class TimePeriodChainTest : TestUnitBase
    {
        ...
        public void CopyConstructorTest()
        {
            ...
            var timePeriods = new TimePeriodChain(schoolDay);
        ...
        {
            Assert.Empty(new TimePeriodChain());
        ...
        public void MoveTest()
        {
            ...
            var startDuration = schoolDay.Duration;
        ...
        public void InsertTest()
        {
            ...
            var count = schoolDay.Count;
            var start = schoolDay.Start;
            var lesson1 = new Lesson(schoolDay.Start);
            ...
            var shortBreak1 = new ShortBreak(schoolDay.Start);
            ...
            count = schoolDay.Count;
            var end = schoolDay.End;
            var shortBreak2 = new ShortBreak(schoolDay.Start);
        ...
        public void ContainsTest()
        {
            ...
            Assert.DoesNotContain(new TimeRange(), schoolDay);
            Assert.DoesNotContain(new TimeBlock(), schoolDay);

            Assert.Contains(schoolDay.Lesson1, schoolDay);
            Assert.Contains(schoolDay.Break1, schoolDay);
            Assert.Contains(schoolDay.Lesson2, schoolDay);
            Assert.Contains(schoolDay.Break2, schoolDay);
            Assert.Contains(schoolDay.Lesson3, schoolDay);
            Assert.Contains(schoolDay.Break3, schoolDay);
            Assert.Contains(schoolDay.Lesson4, schoolDay);

            schoolDay.Remove(schoolDay.Lesson1);
            Assert.DoesNotContain(schoolDay.Lesson1, schoolDay);
        } // ContainsTest
        ...
        public void IndexOfTest()
        {
            ...
            Assert.Equal(-1, schoolDay.IndexOf(new TimeRange()));
            Assert.Equal(-1, schoolDay.IndexOf(new TimeBlock()));
            ...
            schoolDay.Remove(schoolDay.Lesson1);
            Assert.Equal(-1, schoolDay.IndexOf(schoolDay.Lesson1));
        } // IndexOfTest
        ...
        public void CopyToTest()
        {
            ...
            var timePeriods = new TimePeriodChain();
            var array1 = Array.Empty<ITimePeriod>();
            timePeriods.CopyTo(array1, 0);

            var schoolDay = new SchoolDay();
            var array2 = new ITimePeriod[schoolDay.Count];
            ...
            var array3 = new ITimePeriod[schoolDay.Count + 3];
        ...
        public void RemoveTest()
        {
            ...
            var count = schoolDay.Count;
            var end = schoolDay.End;
            var removeItem = schoolDay.First;
            var duration = schoolDay.Duration;
            ...
            var start = schoolDay.Start;
            var first = schoolDay.First;
            var last = schoolDay.Last;
        ...
        {
            var schoolDay = new SchoolDay();
            var manualRange = new TimeRange(schoolDay.Start, schoolDay.End);

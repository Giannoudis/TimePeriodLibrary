...
namespace Itenso.TimePeriodTests
{
    ...
    public sealed class MinuteTest : TestUnitBase
    {
        ...
        public void InitValuesTest()
        {
            ...
            var firstMinute = new DateTime(now.Year, now.Month, now.Day, now.Hour, now.Minute, 0);
            var secondMinute = firstMinute.AddMinutes(1);
            var minute = new Minute(now, TimeCalendar.NewEmptyOffset());
        ...
        public void DefaultCalendarTest()
        {
            ...
            for (var hourMinute = 0; hourMinute < TimeSpec.MinutesPerHour; hourMinute++)
            {
                var minute = new Minute(currentHour.AddMinutes(hourMinute));
        ...
        public void AddMinutesTest()
        {
            ...
            var previousMinute = nowMinute.AddMinutes(-1);
            ...
            var nextMinute = nowMinute.AddMinutes(1);
